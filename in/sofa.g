...
obj (table_base){ joint:rigid type:ssBox, size:[0.3 0.6 0.1 .005], contact:1 Q:<[  0.75, 0.75, 0.0, 1, 0, .0, .0]> color:[0.9, 0.1, 0.1, 1]}
goal (table_base){ type:ssBox, size:[0.2 0.2 0.1 .005], contact:0 Q:<[  -0.75, -.75, 0.0, 1, 0, .0, .0]> color:[0.4, 1, 0.4, 0.3]}
