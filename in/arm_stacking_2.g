...
goal1 (table_base){ type:ssBox, size:[0.2 0.2 0.1 .002], contact:0 Q:<[  -0.1, .1, 0.03, 1, 0, .0, 0]> color:[0.4, 1, 1, 0.3]}
goal2 (table_base){ type:ssBox, size:[0.1 0.2 0.1 .002], contact:0 Q:<[  -0.1, .1, 0.156, 1, 0, .0, 0]> color:[0.4, 1, 0.4, 0.3]}
goal3 (table_base){ type:ssBox, size:[0.1 0.2 0.1 .002], contact:0 Q:<[  -0.1, .1, 0.266, 1, 0, .0, 0]> color:[1, 1, 0.4, 0.3]}
