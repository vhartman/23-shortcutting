...
obj (World){ joint:rigid type:ssBox, size:[0.5 0.5 0.5 .04], contact:1 Q:<[  -3, -0, 0.3, -1, 1, .0, 0]> color:[0.9, 0.1, 0.1, 1]}
goal (World){ type:ssBox, size:[0.4 0.4 0.4 .005], contact:0 Q:<[  3, 2, 0.25, 1, 0, .0, .0]> color:[0.4, 1, 0.4, 0.3]}
